...
![NewBedwars Banner](https://raw.githubusercontent.com/YOUR_USERNAME/NewBedwars/main/assets/banner_main_exported.png)
...
| **Blast Protection Glass** | TNT/explosion-immune barrier item |
...
| **Spectator Effects GUI** | Special visual effects available to spectators |
| **TNT Particles** | Red dust particles above players holding TNT |
| **Victory Fireworks** | Firework display for the winning team |
...
/bw rejoin            — Rejoin your previous arena (within rejoin window)
...
6. Enter setup mode: `/bw arena setup myArena`
7. Follow the checklist shown by `/bw arena`
...
- [ ] More supported Minecraft versions (1.19.x, 1.21.x)
...
Found a bug or have a suggestion? Please open an issue on **[GitHub](https://github.com/YOUR_USERNAME/NewBedwars/issues)** or use the platform's discussion section.

> Please do not leave a negative review without first reporting your issue. Most problems can be resolved quickly with a bug report.

---

## 📸 Screenshots

*Screenshots coming soon — see the gallery tab.*
